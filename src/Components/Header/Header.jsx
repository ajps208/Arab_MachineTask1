...
function Header({isSidebarVisible,setShowSidebar}) {
  ...
  return (
    <>
      <div className="h-12 md:h-28 relative flex justify-between items-center ">
        
        <div className="imgdiv flex justify-center items-center ">
       <div className="absolute top-4 flex justify-center items-center">
          <i onClick={btnclicked} className="fa-solid fa-bars md:hidden absolute right-24 text-4xl text-cyan-200 "></i>
            {/* logo image */}
            <img
              width={"60px"}
              src={logo}
        ...
        <div className="flex mt-16 md:mt-0 md:me-24 me-5">
          ...
          <div className="bg-white h-9 flex rounded-md p-1 shadow">
            ...
            <p className="md:ms-2 md:me-2 hidden md:block font-sans">XYZ Enterprises pvt.Ltd</p>
          </div>
